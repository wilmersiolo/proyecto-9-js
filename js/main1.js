function calcularEdad() {
    ...
    if (!isNaN(edad)) {
        ...
        document.getElementById("resultadoedad").innerHTML = 'ingrese por favor su edad.';
    }
}
function peso_estatura() {
    ...
    if (isNaN(edad)) {
        document.getElementById("pesoEstatura").innerHTML = ' <strong>Por favor, ingrese un valor entero válido para la edad. </strong>';
        return;
    }
...
function calcular_IMC() {
    ...
    if (!isNaN(peso) && !isNaN(estatura) && peso > 0 && estatura > 0) {
        ...
        document.getElementById("resultadoIMC").innerHTML = "Por favor, ingrese tu peso y tu estatura.";
    }
}
...
function calcularArterial() {
    ...
    if (!isNaN(presionSistolica)) {
        ...
        document.getElementById("resultadoPresion").innerHTML = '<strong>Por favor, ingrese un valor entero valido para la presion arterial.</strong>';
    }
}